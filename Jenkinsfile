    ...
    stages {
        stage('Build Test Deploy') {
            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import numpy; import pandas; import matplotlib; import scipy; import spacy; import math; import datascience; import matplotlib.pyplot"'
